...
1. **Dataset**: Use the **PlantVillage Dataset** (available on Kaggle). It contains 54,000+ images of 14 crop species.
2. **Architecture**: Use **MobileNetV2** for transfer learning because it is lightweight and runs fast on mobile/web servers.
...
- **Confidence Threshold**: In model\_loader.py, if confidence < 0.70, the system should return a "Low Confidence" warning asking for a clearer image.
